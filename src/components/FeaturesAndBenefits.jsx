...
const FeaturesAndBenefits = ({ className = "" }) => {
  return (
    ...
    >
      <img
        className="absolute top-[-24px] left-[99px] w-[300px] h-[300px] object-cover mix-blend-multiply"
        alt=""
        src="/removebgai-1721140865383-1@2x.png"
        id="features"
      />
      <img
        className="absolute top-[14px] left-[1555px] w-[200px] h-[200px] object-cover"
        alt=""
      ...
      <img
        className="absolute top-[1160px] left-[149px] w-[200px] h-[200px] object-cover"
        alt=""
        src="/clock-1@2x.png"
      />
      <img
        className="absolute top-[1135px] left-[1530px] w-[250px] h-[250.4px] object-cover"
        alt=""
        src="/removebgai-1721319104166-1@2x.png"
      />
      <div className="absolute top-[102px] left-[826px] w-[269px] h-[119px] text-justify text-26xl text-gold font-inter">
        <img
          className="absolute top-[0px] left-[0px] rounded-81xl w-[269px] h-[119px]"
          alt=""
          src="/rectangle-15.svg"
        />
        <b className="absolute top-[33px] left-[calc(50%_-_112.5px)] [text-shadow:0px_4px_4px_rgba(255,_224,_114,_0.75)]" >
          Tính Năng
        </b>
      </div>
    </div>
